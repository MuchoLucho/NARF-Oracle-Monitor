        ...
        <div class="container">
            ...
            <div class="row">
                <form class="col-md-12" action="#" method="get">
                    ...
                    <div class='form-group'>
                        <input type='text' class='form-control input-lg' placeholder='SID'>
                    </div>
                    <div class='form-group'>
                        <input type='text' class='form-control input-lg' placeholder='Host Name'>
                    </div>
                    <div class='form-group'>
                        <input type='text' class='form-control input-lg' placeholder='Port'>
                    </div>
                    <div class='form-group'>
